    ...
    <main className="nw-main">
      ...
      <div className="nw-topbar">
        ...
        <div className="nw-health-block">
          <div className="nw-health-score">
            72 <span style={{ fontSize: 14, color: "#bbb" }}>/100</span>
          </div>
          ...
          {goals.map((g) => (
            <div className="nw-goal-item" key={g.name}>
              <div className="nw-goal-header">
                ...
                <span className="nw-goal-progress-text">
                  {fmt(g.current)} / {fmt(g.target)} — {pct(g.current, g.target)}%
                </span>
              </div>
              <div className="nw-goal-track">
                <div
                  className="nw-goal-fill"
                  style={{ width: `${pct(g.current, g.target)}%`, background: g.color }}
                />
              </div>
            </div>
          ))}
